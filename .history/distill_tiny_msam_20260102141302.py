...
def main():
    ...
    parser.add_argument("--train_anno_UIIS", default="/data2/wuxinrui/Datasets/UIIS/UDW/annotations_rle/train_rle_10_points.json", type=str, required=False, help="path to the annotation file")
    ...
    parser.add_argument("--T_checkpoint_path", default="/data2/wuxinrui/Distill-SAM/weights/temp_weights/distillv3.pth", type=str, required=False, help="path to the checkpoint")
    ...
    parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_T_vit_t_S_tiny_msam_1/temp/all50epoch_ocean100epoch.pth", type=str, required=False, help="path to the checkpoint") #g tiny_msam
    # parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_T_vit_t_S_vit_t/temp/step=43650-val_av_BS_IoU=0.8981.pth", type=str, required=False, help="path to the checkpoint") #g vit_t
    ...
    # parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_T_vit_t_S_tiny_msam/temp_copy/stroke_v8.pth", type=str, required=False, help="path to the checkpoint") #g tiny_msam
    ...
    trainer.fit(model, ckpt_path="/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_T_vit_t_S_tiny_msam/last-v6.ckpt")
    # trainer.fit(model, )
