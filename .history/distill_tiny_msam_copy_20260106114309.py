...
def main():
    ...
    trainer.fit(model, ckpt_path="/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_copy_T_vit_t_S_tiny_msam_onlydistill_False_adddistill_True/step=24850-val_av_BS_IoU=0.6481.ckpt")
    # trainer.fit(model, )
