...
def main():
    ...
    # parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/RA-L/MobileSAM/weights/sam_vit_h_4b8939.pth", type=str, required=False, help="path to the checkpoint") #g vit_h
    ...
    # parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/RA-L/MobileSAM/trained_models/Img_Encoder_copy_copy_T_vit_t_S_vit_t/step=58200-val_av_BS_IoU=0.9162.ckpt", type=str, required=False, help="path to the checkpoint") #g vit_t
