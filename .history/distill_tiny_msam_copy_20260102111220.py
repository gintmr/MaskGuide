...
def main():
    ...
    # parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/RA-L/MobileSAM/trained_models/Img_Encoder_copy_copy_T_vit_t_S_tiny_msam/temp/only_distill_50epoch_mask&unmask_8850.pth", type=str, required=False, help="path to the checkpoint") #g tiny_msam
