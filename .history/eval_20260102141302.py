...
def main():
    ...
    # parser.add_argument("--checkpoint_path", type=str, default="/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_T_vit_t_S_tiny_msam/temp_copy/stroke_v8.pth", help="path to the checkpoint")
    parser.add_argument("--checkpoint_path", type=str, default="/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_T_vit_t_S_vit_t/temp/last.pth", help="path to the checkpoint")
    # parser.add_argument("--checkpoint_path", type=str, default="/data2/wuxinrui/Distill-SAM/weights/mobile_sam.pt", help="path to the checkpoint")
    # parser.add_argument("--checkpoint_path", type=str, default="//data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_T_vit_t_S_micro_sam/temp/micro_sam_stage10.pth", help="path to the checkpoint")
    # parser.add_argument("--checkpoint_path", type=str, default="/data2/wuxinrui/Distill-SAM/weights/sam_vit_h_4b8939.pth", help="path to the checkpoint")
    ...
    parser.add_argument("--visualize_mask_path", default="/data2/wuxinrui/Distill-SAM/modified_mobilesam_results")
    ...
    log_filename = f"/data2/wuxinrui/Distill-SAM/baseline_eval/eval_{checkpoint_name}.log"
    logging.basicConfig(
