...
def main():
    ...
    parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/RA-L/MobileSAM/trained_models/Distilled_encoder/last-v27.ckpt", type=str, required=False, help="path to the checkpoint")
