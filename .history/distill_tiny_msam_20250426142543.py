...
def main():
    ...
    parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/RA-L/MobileSAM/trained_models/Distilled_encoder/tiny_TinyViT_1_5epoch.pth", type=str, required=False, help="path to the checkpoint")
