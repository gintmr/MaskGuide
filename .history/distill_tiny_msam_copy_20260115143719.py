...
def main():
    ...
    parser.add_argument("--epochs", type=int, default=40, help="number of steps")
    parser.add_argument("--num_points", type=int, default=30, help="number of random points")
    ...
    val_dataset = Coco2MaskDataset(data_root=args.train_data_IMC, annotation_path=args.train_anno_IMC, image_size=args.image_size,length=args.length,num_points=args.num_points,use_centerpoint=args.use_centerpoint)
    ...
    # trainer.fit(model, ckpt_path="/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_copy_T_vit_t_S_tiny_msam_onlydistill_False_adddistill_True/last.ckpt")
    # trainer.fit(model, )
