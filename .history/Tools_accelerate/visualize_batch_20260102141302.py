...
if __name__ == '__main__':
    ...
    features_folder = [os.path.join('/data2/wuxinrui/Distill-SAM/Tools_accelerate', mode_type) for mode_type in chosen_mode_type]
    ...
    for common_features_name in common_features_names:
        ...
        save_path = os.path.join('/data2/wuxinrui/Distill-SAM/Tools_accelerate/contrast_visualize', img_name)
        
        possible_img_folder = ['/data2/wuxinrui/Distill-SAM/NEW_MIMC_1024/images/train', '/data2/wuxinrui/Distill-SAM/NEW_MIMC_1024/images/val', '/data2/wuxinrui/Datasets/UIIS/UDW/train', '/data2/wuxinrui/Datasets/UIIS/UDW/val', '/data2/wuxinrui/Datasets/IMC_1000/MIMC_FINAL/seen/train_list', '/data2/wuxinrui/Datasets/IMC_1000/MIMC_FINAL/seen/test_list']
