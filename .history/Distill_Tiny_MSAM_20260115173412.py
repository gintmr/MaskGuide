...
def main():
    ...
    parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_T_vit_t_S_tiny_msam_onlydistill_True_adddistill_True/step=11850-val_av_BS_IoU=0.7599.pth", type=str, required=False, help="path to the checkpoint") #g tiny_msam
