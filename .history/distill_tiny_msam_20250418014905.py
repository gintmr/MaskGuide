...
def main():
    ...
    parser.add_argument("--S_model", default='wxr_t', type=str, required=False, help="model type")
    ...
    parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/RA-L/MobileSAM/trained_models/Distilled_encoder/COCO_MIMC_plus_new26epoch_COCO.pth", type=str, required=False, help="path to the checkpoint")
