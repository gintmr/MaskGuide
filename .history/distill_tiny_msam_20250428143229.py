...
def main():
    ...
    parser.add_argument('--every_n_train_steps', default=200)
    ...
    # trainer.fit(model, ckpt_path="/data2/wuxinrui/RA-L/MobileSAM/trained_models/Distilled_encoder/last-v21.ckpt")
    # trainer.fit(model, )
    # save_checkpoint = {}
