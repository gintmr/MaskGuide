...
if __name__ == "__main__":
    annotation_file = "/data2/wuxinrui/Distill-SAM/NEW_MIMC/annotations/train.json"  # 替换为 COCO JSON 文件路径
    image_folder = "/data2/wuxinrui/Distill-SAM/NEW_MIMC/images/train"                  # 替换为 COCO 图像文件夹路径
