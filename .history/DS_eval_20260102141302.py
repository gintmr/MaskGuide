...
def main():
    ...
    parser.add_argument("--checkpoint_path", type=str, default="/data2/wuxinrui/Distill-SAM/trained_models/Distilled_encoder/Distilled.pth", help="path to the checkpoint")
    # parser.add_argument("--checkpoint_path", type=str, default="/data2/wuxinrui/Distill-SAM/trained_models/standard_mimc/final_model.pth", help="path to the checkpoint")
