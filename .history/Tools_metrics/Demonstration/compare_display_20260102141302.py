import sys
sys.path.append('/data2/wuxinrui/Distill-SAM')
...
import cv2
import numpy as np
IMG_path = "/data2/wuxinrui/Distill-SAM/NEW_MIMC_1024/images/train"
GT_path = "/data2/wuxinrui/Distill-SAM/NEW_MIMC_1024/annotations/train.json"
...
for i, data in enumerate(dataloader):
    ...
    for img, label, coco_image_name in zip(imgs,labels,coco_image_names):
        try:
            ...
            output_path_combined = f"/data2/wuxinrui/Distill-SAM/Tools_metrics/Demonstration/display/{coco_image_name}"
