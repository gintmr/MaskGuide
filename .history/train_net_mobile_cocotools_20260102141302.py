...
def main():
    ...
    parser.add_argument("--checkpoint_path", default="/data2/wuxinrui/Distill-SAM/trained_models/Distilled_encoder/msam_mix_data_2epoch.pth", type=str, required=False, help="path to the checkpoint")
