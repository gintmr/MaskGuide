...
def main():
    ...
    parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/Distill-SAM/weights/xavier_init_tiny_msam.pth", type=str, required=False, help="path to the checkpoint") #g tiny_msam
