...
for k, v in state_dict.items():
    ...
    elif "T_model." in k and "image_encoder" in k:
        if "prompt_encoder" or "mask_decoder" in k:
            save_checkpoint[k.replace("T_model.", "")] = v

torch.save(save_checkpoint, "/data2/wuxinrui/RA-L/MobileSAM/trained_models/Distilled_encoder/msam_mix_data_qepoch.pth")