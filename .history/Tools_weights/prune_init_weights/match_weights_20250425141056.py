...
pruned_state = torch.load("/data2/wuxinrui/RA-L/MobileSAM/Tools_weights/prune_init_weights/init_weights_tiny_msam.pth")
...
def load_matched_weights(pruned_state, complex_state_dict, init_mode='current'):
    ...
    torch.save(pruned_state, "/data2/wuxinrui/RA-L/MobileSAM/Tools_weights/prune_init_weights/init_weights_tiny_msam.pth")
