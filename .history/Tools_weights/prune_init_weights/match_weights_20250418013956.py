...
pruned_state = torch.load("/data2/wuxinrui/RA-L/MobileSAM/init_weights_wxr_t.pth")
...
def load_matched_weights(pruned_state, complex_state_dict):
    ...
    torch.save(pruned_state, "/data2/wuxinrui/RA-L/MobileSAM/weights/weights_prune_init_weights_wxr_t/pruned_weights.pth")
