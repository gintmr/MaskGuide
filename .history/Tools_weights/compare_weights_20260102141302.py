...
# 加载两个模型的 state_dict
state_dict_path1 = '/data2/wuxinrui/Distill-SAM/weights/weights_prune_init/init_weights_tiny_msam.pth'  # 替换为第一个模型的权重文件路径
state_dict_path2 = '/data2/wuxinrui/Distill-SAM/trained_models/Distilled_encoder/COCO_train_1epoch.pth'  # 替换为第二个模型的权重文件路径
