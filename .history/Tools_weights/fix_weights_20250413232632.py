...
checkpoint = torch.load("/data2/wuxinrui/RA-L/MobileSAM/trained_models/Distilled_encoder/last-v11.ckpt", map_location="cuda")
...
torch.save(save_checkpoint, "/data2/wuxinrui/RA-L/MobileSAM/trained_models/Distilled_encoder/COCO_MIMC_plus_new26epoch.pth")