...
def main():
    ...
    #################G MIMC
    parser.add_argument("--train_data_IMC", default="/data2/wuxinrui/Datasets/IMC_1000/MIMC_FINAL/seen/train_list", type=str, required=False, help="path to the data root")
    parser.add_argument("--train_anno_IMC", default="/data2/wuxinrui/Datasets/IMC_1000/MIMC_FINAL/train-taxonomic_cleaned.json", type=str, required=False, help="path to the annotation file")

    parser.add_argument("--val_data_IMC", default="/data2/wuxinrui/Datasets/IMC_1000/MIMC_FINAL/seen/test_list", type=str, required=False, help="path to the data root")
    parser.add_argument('--val_anno_IMC', default="/data2/wuxinrui/Datasets/IMC_1000/jsons_for_salient_instance_segmentation/test_1_prompts.json", )

    ################G UIIS
    parser.add_argument("--train_data_UIIS", default="/data2/wuxinrui/Datasets/UIIS/UDW/train", type=str, required=False, help="path to the data root")
    parser.add_argument("--train_anno_UIIS", default="/data2/wuxinrui/Datasets/UIIS/UDW/annotations_rle/train_rle.json", type=str, required=False, help="path to the annotation file")

    parser.add_argument("--val_data_UIIS", default="/data2/wuxinrui/Datasets/UIIS/UDW/val", type=str, required=False, help="path to the data root")
    parser.add_argument('--val_anno_UIIS', default="/data2/wuxinrui/Datasets/UIIS/UDW/annotations_rle/val_rle_1_points.json", )


    ################G MIMC_1024
    parser.add_argument("--train_data_MIMC", default="/data2/wuxinrui/Distill-SAM/NEW_MIMC_1024/images/train", type=str, required=False, help="path to the data root")
    parser.add_argument("--train_anno_MIMC", default="/data2/wuxinrui/Distill-SAM/NEW_MIMC_1024/annotations/train.json", type=str, required=False, help="path to the annotation file")

    parser.add_argument("--val_data_MIMC", default="/data2/wuxinrui/Distill-SAM/NEW_MIMC_1024/images/val", type=str, required=False, help="path to the data root")
    parser.add_argument('--val_anno_MIMC', default="/data2/wuxinrui/Distill-SAM/NEW_MIMC_1024/annotations/val.json", )
    ...
    ############G cityscapes
    parser.add_argument("--train_data_cityscapes", default="/data2/wuxinrui/Datasets/Cityscapes/gtFine_trainvaltest/gtFine/train", type=str, required=False, help="path to the data root")
    parser.add_argument("--train_anno_cityscapes", default="/data2/wuxinrui/Datasets/Cityscapes/COCO(cityscapes)/instancesonly_filtered_gtFine_train.json", type=str, required=False, help="path to the annotation file")

    parser.add_argument("--val_data_cityscapes", default="/data2/wuxinrui/Datasets/Cityscapes/gtFine_trainvaltest/gtFine/val", type=str, required=False, help="path to the data root")
    parser.add_argument('--val_anno_cityscapes', default="/data2/wuxinrui/Datasets/Cityscapes/COCO(cityscapes)/instancesonly_filtered_gtFine_val.json", type=str, required=False, help="path to the annotation file")
    ...
    # parser.add_argument("--T_checkpoint_path", default="/data2/wuxinrui/Distill-SAM/weights/sam_vit_h_4b8939.pth", type=str, required=False, help="path to the checkpoint")
    ...
    # parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_T_vit_t_S_vit_h/last-v3.ckpt", type=str, required=False, help="path to the checkpoint") #g vit_h
    # parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/Distill-SAM/weights/sam_vit_h_4b8939.pth", type=str, required=False, help="path to the checkpoint") #g vit_h
    # parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/Distill-SAM/weights/temp_weights/distillv3.pth", type=str, required=False, help="path to the checkpoint") #g vit_t
    # parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_copy_copy_T_vit_t_S_vit_t/step=58200-val_av_BS_IoU=0.9162.ckpt", type=str, required=False, help="path to the checkpoint") #g vit_t
    # parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/Distill-SAM/trained_models/Mask_Decoder_T_vit_h_S_vit_t/last-v5.ckpt", type=str, required=False, help="path to the checkpoint") #g vit_t
    ...
    parser.add_argument("--num_points", type=int, default=1, help="number of random points")
    ...
    if not args.only_distill:
        ...
        train_dataset_cityscapes = Coco2IMGDataset(data_root=args.train_data_cityscapes, image_size=args.image_size,)
        train_dataset_UIIS = Coco2IMGDataset(data_root=args.train_data_UIIS, annotation_path=args.train_anno_UIIS, image_size=args.image_size,length=args.length,num_points=args.num_points,use_centerpoint=args.use_centerpoint)
    ...
    # val_dataset = Coco2MaskDataset(data_root=args.val_data_MIMC, annotation_path=args.val_anno_MIMC, image_size=args.image_size,length=args.length, num_points=args.num_points,use_centerpoint=args.use_centerpoint)
    ...
    log_dir = "./metrics_logs/" + args.Tar + f"_T_{args.T_model}_S_{args.S_model}"
    
    output_dir = os.path.join("/data2/wuxinrui/Distill-SAM/trained_models/", f"{args.Tar}_T_{args.T_model}_S_{args.S_model}")
