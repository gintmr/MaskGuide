...
# trans_pth("/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_T_vit_t_S_rep_sam/temp/rep_sam_stage3.pth")

# trans_ckpt("/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_copy_copy_T_vit_t_S_tiny_msam/step=313950-val_av_BS_IoU=0.8875.ckpt", "/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_copy_copy_T_vit_t_S_tiny_msam/temp/only_distill_50epoch_mask&unmask_8870.pth")
# trans_ckpt("/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_T_vit_t_S_micro_sam/last-v6.ckpt", "/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_T_vit_t_S_micro_sam/temp/micro_sam_stage6.pth")

# compare_mask_decoders("/data2/wuxinrui/Distill-SAM/trained_models/Mask_Decoder_T_vit_h_S_vit_t/last.ckpt", "/data2/wuxinrui/Distill-SAM/weights/mobile_sam.pt")
