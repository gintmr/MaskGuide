...
def main():
    ...
    ###############G Target
    parser.add_argument("--Tar", default="Img_Encoder_copy", choices=["Img_Encoder", "Mask_Decoder", "Prompt_Encoder"],type=str, required=False, help="target to be distilled")
    ...
    # parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_copy_copy_T_vit_t_S_tiny_msam/temp/only_distill_50epoch_mask&unmask_8850.pth", type=str, required=False, help="path to the checkpoint") #g tiny_msam
    ...
    parser.add_argument("--learning_rate", type=float, default=1.0e-3, help="learning rate")
    ...
    # trainer.fit(model, ckpt_path="/data2/wuxinrui/Distill-SAM/trained_models/Img_Encoder_copy_copy_T_vit_h_S_vit_t/step=109100-val_av_BS_IoU=0.9151.ckpt")
    trainer.fit(model, )
