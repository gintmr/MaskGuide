...
python /data2/wuxinrui/RA-L/MobileSAM/eval.py --checkpoint_path /data2/wuxinrui/RA-L/MobileSAM/trained_models/Distilled_encoder/COCO_MIMC_plus_10epoch.pth --label_num 1 --visualize_mask_path /data2/wuxinrui/RA-L/MobileSAM/baseline_eval/temp

python /data2/wuxinrui/RA-L/MobileSAM/eval.py --checkpoint_path /data2/wuxinrui/RA-L/MobileSAM/trained_models/Distilled_encoder/COCO_MIMC_plus_10epoch.pth --label_num 3 --visualize_mask_path /data2/wuxinrui/RA-L/MobileSAM/baseline_eval/temp

python /data2/wuxinrui/RA-L/MobileSAM/eval.py --checkpoint_path /data2/wuxinrui/RA-L/MobileSAM/trained_models/Distilled_encoder/COCO_MIMC_plus_10epoch.pth --label_num 5 --visualize_mask_path /data2/wuxinrui/RA-L/MobileSAM/baseline_eval/temp
