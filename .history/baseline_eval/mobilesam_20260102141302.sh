...
# python /data2/wuxinrui/Distill-SAM/eval.py --checkpoint_path /data2/wuxinrui/Distill-SAM/trained_models/wxr_modified_mobilesam/random_point_v2_bbox.pth --label_num 1 --visualize_mask_path /data2/wuxinrui/Distill-SAM/baseline_eval/temp

# python /data2/wuxinrui/Distill-SAM/eval.py --checkpoint_path /data2/wuxinrui/Distill-SAM/trained_models/wxr_modified_mobilesam/random_point_v2_bbox.pth --label_num 3 --visualize_mask_path /data2/wuxinrui/Distill-SAM/baseline_eval/temp

# python /data2/wuxinrui/Distill-SAM/eval.py --checkpoint_path /data2/wuxinrui/Distill-SAM/trained_models/wxr_modified_mobilesam/random_point_v2_bbox.pth --label_num 5 --visualize_mask_path /data2/wuxinrui/Distill-SAM/baseline_eval/temp
