...
def main():
    ...
    parser.add_argument("--checkpoint_path", type=str, default="/data2/wuxinrui/RA-L/MobileSAM/trained_models/Distilled_encoder/COCO_MIMC_plus_new26epoch.pth", help="path to the checkpoint")
    ...
    parser.add_argument("--sample_num", default=None, help="sample_num")
