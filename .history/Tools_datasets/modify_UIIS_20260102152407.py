...
def main():
    # 输入文件路径 - 修改为UIIS数据集路径
    train_input = "/data2/wuxinrui/HF_data/UIIS/annotations/train.json"
    val_input = "/data2/wuxinrui/HF_data/UIIS/annotations/val.json"
    
    # 输出目录
    output_dir = "/data2/wuxinrui/HF_data/UIIS_standard"
