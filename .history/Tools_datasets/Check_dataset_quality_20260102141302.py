...
# analyze_and_visualize(cocoed_anno, image_folder_path, "/data2/wuxinrui/Distill-SAM/tools_self/visual_datasets")

process_images_and_annotations(cocoed_anno, image_folder_path, "/data2/wuxinrui/Distill-SAM/NEW_MIMC_1024/images/val", "/data2/wuxinrui/Distill-SAM/NEW_MIMC_1024/annotations/val.json")
