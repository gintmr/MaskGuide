...
def main():
    ...
    #################G MIMC
    parser.add_argument("--train_data_IMC", default="/data2/wuxinrui/HF_data/MIMC_FINAL/seen/train", type=str, required=False, help="path to the data root")
    ...
    parser.add_argument("--val_data_IMC", default="/data2/wuxinrui/HF_data/MIMC_FINAL/seen/val", type=str, required=False, help="path to the data root")
