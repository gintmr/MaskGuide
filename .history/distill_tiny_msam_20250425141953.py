...
def main():
    ...
    if not args.only_distill:
        ...
        # train_dataset = train_dataset_VOC
        # val_dataset = val_dataset_VOC
        
        
        train_dataset = combined_datasets([train_dataset_MIMC, train_dataset_COCO, train_dataset_VOC, train_dataset_cityscapes])
        val_dataset = combined_datasets([val_dataset_MIMC, val_dataset_COCO, val_dataset_VOC, val_dataset_cityscapes])
