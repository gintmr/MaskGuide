...
def main():
    ...
    ###############G Target
    parser.add_argument("--Tar", default="Img_Encoder_copy_copy", choices=["Img_Encoder", "Mask_Decoder", "Prompt_Encoder"],type=str, required=False, help="target to be distilled")
    ...
    # parser.add_argument("--T_checkpoint_path", default="/data2/wuxinrui/RA-L/MobileSAM/weights/sam_vit_h_4b8939.pth", type=str, required=False, help="path to the checkpoint") #g vit_h
    parser.add_argument("--T_checkpoint_path", default="/data2/wuxinrui/RA-L/MobileSAM/weights/temp_weights/UIIS854IMC947.pth", type=str, required=False, help="path to the checkpoint") #g vit_h
    ...
    # parser.add_argument("--T_checkpoint_path", default="/data2/wuxinrui/RA-L/MobileSAM/weights/temp_weights/distillv3.pth", type=str, required=False, help="path to the checkpoint") #g vit_t
    ...
    # parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/RA-L/MobileSAM/trained_models/Img_Encoder_copy_copy_T_vit_t_S_tiny_msam/temp/only_distill_50epoch_mask&unmask_8870.pth", type=str, required=False, help="path to the checkpoint") #g tiny_msam
    ...
    parser.add_argument("--epochs", type=int, default=100, help="number of steps")
    ...
    if True:
        ...
        train_dataset = combined_datasets([train_dataset_MIMC, train_dataset_UIIS], sample_weights=[0.8, 0.2])
        # train_dataset = combined_datasets([train_dataset_MIMC])
        # train_dataset = combined_datasets([train_dataset_IMC])
        # train_dataset = combined_datasets([train_dataset_UIIS])
    ...
    output_dir = os.path.join("/data2/wuxinrui/RA-L/MobileSAM/trained_models/", f"{args.Tar}_T_{args.T_model}_S_{args.S_model}")
    ...
    trainer.fit(model, ckpt_path="/data2/wuxinrui/RA-L/MobileSAM/trained_models/Img_Encoder_copy_copy_T_vit_h_S_vit_t/step=109100-val_av_BS_IoU=0.9151.ckpt")
    # trainer.fit(model, )
