...
def main():
    ...
    #################G IMC
    parser.add_argument("--train_data_IMC", default="path_to_datasets/MIMC_FINAL_standard/train_list", type=str, required=False, help="path to the data root")
    parser.add_argument("--train_anno_IMC", default="path_to_datasets/MIMC_FINAL_standard/train.json", type=str, required=False, help="path to the annotation file")
    parser.add_argument("--val_data_IMC", default="path_to_datasets/MIMC_FINAL_standard/val_list", type=str, required=False, help="path to the data root")
    parser.add_argument('--val_anno_IMC', default="path_to_datasets/MIMC_FINAL_standard/val.json", )

    ################G UIIS
    parser.add_argument("--train_data_UIIS", default="path_to_datasets/UIIS/train", type=str, required=False, help="path to the data root")
    parser.add_argument("--train_anno_UIIS", default="path_to_datasets/UIIS_standard/train.json", type=str, required=False, help="path to the annotation file")
    parser.add_argument("--val_data_UIIS", default="path_to_datasets/UIIS/val", type=str, required=False, help="path to the data root")
    parser.add_argument('--val_anno_UIIS', default="path_to_datasets/UIIS_standard/val.json", )

    #############G COCO
    parser.add_argument("--train_data_COCO", default="path_to_datasets/COCO/images/train2017", type=str, required=False, help="path to the data root")
    parser.add_argument("--train_anno_COCO", default="path_to_datasets/COCO_standard/train.json", type=str, required=False, help="path to the annotation file")
    parser.add_argument("--val_data_COCO", default="path_to_datasets/COCO/images/val2017", type=str, required=False, help="path to the data root")
    parser.add_argument('--val_anno_COCO', default="path_to_datasets/COCO_standard/val.json", type=str, required=False, help="path to the annotation file")
    ...
    # parser.add_argument("--T_checkpoint_path", default="./weights/sam_vit_h_4b8939.pth", type=str, required=False, help="path to the checkpoint") #g vit_h
    parser.add_argument("--T_checkpoint_path", default="./weights/mobile_sam.pt", type=str, required=False, help="path to the checkpoint")

    # parser.add_argument("--S_checkpoint_path", default="./weights/temp_weights/UIIS854IMC947.pth", type=str, required=False, help="path to the checkpoint") #g vit_h
    parser.add_argument("--S_checkpoint_path", default="./weights/mobile_sam.pt", type=str, required=False, help="path to the checkpoint") #g vit_t
    ...
    output_dir = os.path.join("./trained_models/", f"{args.Tar}_T_{args.T_model}_S_{args.S_model}_onlydistill_{args.only_distill}_adddistill_{args.add_distill}")
